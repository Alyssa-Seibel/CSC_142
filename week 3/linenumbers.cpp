...
int main() {
    ...
    std::string inputfilename, outputfilename, text;
    int lineNumber = 1;

    std::ifstream inFile;

    std::cout << "Input a file name that you want to read from: ";
    ...
    std::cout << "Input the name of a file you want to transfer it to: ";
